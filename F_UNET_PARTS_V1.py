...
class ResBlock(nn.Module):
    def __init__(self, in_channels, out_channels, n_classes, nonlinear='relu'):
...
class InConv(nn.Module):
    def __init__(self, in_channels, out_channels, n_classes, block=ResBlock, batchsize=4, nonlinear='relu'):
...
class Mid(nn.Module):
    def __init__(self, in_channels, out_channels, n_classes, batchsize=4, nonlinear='relu'):
...
class TransConv(nn.Module):
    def __init__(self, in_channels, batchsize=4, nonlinear='relu'):
